...
{
    public class XdTableManager : EntityManager
    {

        public XdTable ViewXdTableListBymonocrystal(string monocrystal)
        {
            var result = db1.Queryable<XdTable>().Where(o => o.Monocrystal == monocrystal).First();
            return result;
        }
