...
{
    public class DCRManager : EntityManager
    {

        public List<EapDcr> ViewDCRListByLineID(string lineID)
        {
            var result = db1.Queryable<EapDcr>().Where(o => o.LineId == lineID).ToList();
            return result;
        }
