...
{
    public class V_CrystalstickDetailManager : EntityManager
    {

        public V_CrystalstickDetail ViewV_CrystalstickDetailListByCode(string Coding)
        {
            var result = db1.Queryable<V_CrystalstickDetail>().Where(o => o.Coding == Coding).First();
            return result;
        }
